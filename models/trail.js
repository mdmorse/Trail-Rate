...
var trails = [
	...
	new Trail('Dinosaur Ridge','Red Rocks','Very rocky trail that is highly technical. Moderate climbs'),
	new Trail('Blue Lake','Boulder','Beautiful, 6 mile (round trip) hike with moderate grades. Ends at the scenic Blue Lake'),
	new Trail('Elk Meadows','Evergreen Co','Beautiful, 6 mile (round trip) hike with moderate grades. Ends at the scenic Blue Lake')
